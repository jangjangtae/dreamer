...
# 신규 돌파형 Models (A6 ~ A8)
# ---------------------------------------------------------
# A6: Extreme Tester (극단적 보상 증폭, 태스크 보상 최소화)
run_case "a6_extreme_tester" \
  TESTER_ALPHA_TASK_BASE=0.10 \
  TESTER_ALPHA_COV_GLOBAL=0.03 \
  TESTER_ALPHA_DETECT=0.00 \
  TESTER_INIT_W_BUG=0.80 \
  TESTER_MIN_W_BUG=0.50 \
  TESTER_MAX_W_BUG=0.95 \
  CRAFTER_TESTER_AMP=15.0 \
  CRAFTER_TESTER_SUPPRESSION=0.05 \
  CRAFTER_TESTER_REWARD_CAP=5.0

# A7: Smart Full (A5 기반 패널티 임계치 대폭 완화)
run_case "a7_smart_full" \
  TESTER_ALPHA_TASK_BASE=0.20 \
  TESTER_ALPHA_COV_GLOBAL=0.03 \
  TESTER_ALPHA_DETECT=0.05 \
  TESTER_INIT_W_BUG=0.55 \
  TESTER_MIN_W_BUG=0.35 \
  TESTER_MAX_W_BUG=0.90 \
  TESTER_INIT_BETA_COV=0.15 \
  TESTER_MIN_BETA_COV=0.08 \
  TESTER_MAX_BETA_COV=0.25 \
  TESTER_REPEAT_BUDGET=0.25 \
  TESTER_SUSPICION_LOW=1.50 \
  TESTER_SUSPICION_EMA_ALPHA=0.05 \
  CRAFTER_TESTER_REPEAT_PENALTY=0.001

# A8: Curiosity Driven (상태 탐색/커버리지 극대화)
run_case "a8_curiosity_driven" \
  TESTER_ALPHA_TASK_BASE=0.20 \
  TESTER_ALPHA_COV_GLOBAL=0.15 \
  TESTER_ALPHA_DETECT=0.00 \
  TESTER_INIT_W_BUG=0.10 \
  TESTER_MIN_W_BUG=0.00 \
  TESTER_MAX_W_BUG=0.20 \
  TESTER_INIT_BETA_COV=0.60 \
  TESTER_MIN_BETA_COV=0.40 \
  TESTER_MAX_BETA_COV=0.80

echo "===================================================="
echo "ALL EXPERIMENTS (Baseline + A1~A8) DONE"
